...
public class HotActivityController {
	 ...
	 * app 热门tab
	 */
	@RequestMapping(value="hotTabs",method = RequestMethod.GET,params={"pageNum","pageSize"})
	public Object getHotActivityTab(@RequestParam("pageNum") Integer pageNum,@RequestParam("pageSize") Integer pageSize){
