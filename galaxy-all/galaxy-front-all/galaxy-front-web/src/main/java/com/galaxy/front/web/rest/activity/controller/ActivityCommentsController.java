...
public class ActivityCommentsController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "getCommentedActivity1",method = RequestMethod.GET,params = {"user_id","until_id","pageSize"})
	public Object getCommentedActivity1(@RequestParam("user_id") long user_id,@RequestParam("until_id") long until_id,@RequestParam("pageSize") int pageSize){
		/**
		 * sql
		 */
		ResultModel resultModel = new ResultModel();
