...
@RestController(value = "RestActivityNewsController")
...
public class ActivityNewsController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "getMyCreatedActivity",method = RequestMethod.GET,params = {"user_id","until_id","pageSize"})
	public Object getMyCreatedActivity(@RequestParam("user_id") long userId,@RequestParam("until_id") long untilId,@RequestParam("pageSize") int pageSize){
		/*
