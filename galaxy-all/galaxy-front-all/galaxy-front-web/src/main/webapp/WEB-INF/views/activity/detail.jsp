...
<div id="main-wrap"> 
  <div class="sitenav">    
      <a href="/">首页</a>&nbsp;»&nbsp;<a href="http://www.o2olive.net/demo/index.php?act=groupbuy&op=list&class_id=1">餐饮美食</a>&nbsp;»&nbsp;<a href="http://www.o2olive.net/demo/index.php?act=groupbuy&op=list&class_id=1&class_id_1=2">自助餐</a>&nbsp;»&nbsp;俏江南  </div>
 
  <div class="group-detail-con">
    <div class="gd-title">
      <h1>活动名称</h1>
      <p class="gd-des">活动描述活动描述活动描述活动描述活动描述活动描述活动描述活动描述活动描述活动描述活动描述活动描述</p>
    </div>
    <div class="gd-con">
      <div class="group-pic">
          <!-- 活动封面 -->
          <img src="/resources/images/0eb1ccc3dbae8d94ea32a73986979f08.jpg">
      ...
      <div class="group-info">
          <div class="prices-box gr">
             ...
             <span class="price-tag red">3.3 折 </span> <del class="item">¥<!--节省968-->1436</del> 
          </div>
    ...
    <div class="layout_left02 clearfix">
      <div class="group-detail-box">
        ...
        <div class="group-detail-main gr">
          <h2 class="standard-bar" id="store_intro">活动介绍</h2>
          ...
          <div class="map-business">
            <div class="map-box mr30">
              <div class="shop_map" id="container" style="width: 310px; height: 200px; margin: 0px auto; overflow: hidden; position: relative; z-index: 0; color: rgb(0, 0, 0); text-align: left; background-color: rgb(243, 241, 236);">
                 <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 51px; cursor: url(http://api.map.baidu.com/images/openhand.cur) 8 8, default;"><div class="BMap_mask" style="position: absolute; left: 0px; top: -51px; z-index: 9; overflow: hidden; -webkit-user-select: none; width: 310px; height: 200px;">
                 </div>
