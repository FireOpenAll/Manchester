    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <li class="active">
            <a href="/resources/mqtt/2lemetry MQTT Client.html">MQTT Client</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="col-md-12">
    <div class="well" id="disconnectSettings">
      <h4 id="connectedTo">
        ...
        <a class="btn btn-warning pull-right" href="http://mqtt.io/#doDisconnect" id="doDisconnect">Disconnect</a>
      </h4>
    </div>
    <form class="well" id="connectionSettings" role="form">
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input class="form-control" data-toggle="tooltip" id="hostnameInput" placeholder="Enter host name" title="" value="q.m2m.io" data-original-title="Use any MQTT broker that supports web sockets.">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input class="form-control" data-toggle="tooltip" id="clientIdInput" placeholder="Enter client ID" title="" data-original-title="MQTT client ID. 1-23 characters long.">
              </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="checkbox">
                  <label data-toggle="tooltip" title="" data-original-title="Uncheck to preserve the list of subscriptions and to receive queued QOS 1 and 2 messages.">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input class="form-control" data-toggle="tooltip" id="keepAliveInput" placeholder="Enter keep alive time" title="" value="30" data-original-title="Keep alive in seconds.">
              </div>
            </div>
        ...
        <div class="col-md-4">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="checkbox">
                <label data-toggle="tooltip" title="" data-original-title="q.m2m.io requires passwords to be hashed.">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" data-toggle="tooltip" id="lastWillQosInput" title="" data-original-title="QoS1: at most once, QoS2: at least once, QoS3: exactly once.">
                  <option>0</option>
                  <option>1</option>
                  <option>2</option>
                </select>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <hr>
          <a class="btn btn-success btn-lg" href="http://mqtt.io/#doConnect" id="doConnect">Connect</a>
        </div>
      </div>
    </form>
  </div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form class="well" role="form">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <select class="form-control" data-toggle="tooltip" id="qosSubInput" title="" data-original-title="QoS1: at most once, QoS2: at least once, QoS3: exactly once.">
                  <option>0</option>
                  <option>1</option>
                  <option>2</option>
                </select>
          ...
          <a class="btn btn-primary" href="http://mqtt.io/#doSubscribe" id="doSubscribe">Subscribe</a>
      ...
      <div class="col-md-12">
        ...
        <form class="well" role="form">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="form-group">
                ...
                <select class="form-control" data-toggle="tooltip" id="qosPubInput" title="" data-original-title="QoS1: at most once, QoS2: at least once, QoS3: exactly once.">
                  <option>0</option>
                  <option>1</option>
                  <option>2</option>
                </select>
          ...
          <a class="btn btn-primary" href="http://mqtt.io/#doPublish" id="doPublish">Publish</a>
  ...
  <div class="col-md-6">
    ...
    <div class="footer">
      <p class="navbar-text navbar-left">
        Â© Copyright 2014 2lemetry, LLC. All Rights Reserved.
      </p>
    </div>
    ...
    <script src="/resources/mqtt/com.atlassian.jira.collector.plugin.jira-issue-collector-plugin-issuecollector.js" type="text/javascript"></script>
  

<a href="http://mqtt.io/#" id="atlwdg-trigger" class="atlwdg-trigger atlwdg-SUBTLE">Provide Feedback</a><div id="atlwdg-blanket" class="atlwdg-blanket" style="display: none;"></div><div id="atlwdg-container" class="atlwdg-popup atlwdg-box-shadow atlwdg-hidden"></div></body></html>